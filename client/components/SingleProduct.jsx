      ...
      <div>
        <div id="product-container">
          ...
          <div id="single-product-img-container">
            <img className="single-product-image" src={singleProduct.imgUrl} />
          </div>
          <div id="single-product-info">
            ...
            <div id="product-direct-information">
              <div id="product-title-container">
                <h2 id="single-product-title">{singleProduct.name}</h2>
              </div>
              <div id="product-year">
              ...
              <div id="artist-info">
                <h3 id="artist-name">{singleProduct.artistName}</h3>
                <h3 id="artist-nationality">{singleProduct.nationality}</h3>
              </div>
              <div id="item-description-container">
                <p id="item-description">{singleProduct.description}</p>
              </div>
              <div id="purchase-information">
                <div id="item-price-quant">
                  <h3 id="quantity-info">In stock: {singleProduct.stock}</h3>
                  <h3 id="price-info">
              ...
              <div id="tag-container">
                ...
                <div id="categorie-cont">
                  {singleProduct.categories.map((currCat) => {
                    return (
                      <div className="category-single-product" key={currCat.id}>
                        <p>{currCat.name}</p>
                      </div>
                    );
                  })}
